  ...
  return (
    ...
    {isActive && activeItem && (
      <>
        ...
        <motion.div layout layoutId="nowWatching" className="fixed flex flex-col self-center inset-0 h-96 w-max max-w-[80vw] z-10 mx-auto bg-muted">
        <div>
        ...
        <Item key={activeItem.title} variant="outline" role="listitem">
                ...
                <a href={activeItem.link} target="_blank">
    ...
    <BlurFade delay={0.04 * 4}>
      <ItemGroup className="gap-4">
          {items.map((item) => (
            <motion.div key={item.title}  onClick={() => {setIsActive(true); setActiveItem(item)}} className="cursor-pointer"  layoutId="nowWatching">
            <Item variant="outline" role="listitem">
                ...
                <a onClick={(e)=> e.stopPropagation()} href={item.link} target="_blank">
                <ItemContent className="flex-none text-center">
                  <ItemDescription>Watch</ItemDescription>
                </ItemContent>
                </a>
